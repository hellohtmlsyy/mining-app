...
axios.defaults.headers.get['Accept'] = 'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'; //配置请求头
axios.defaults.headers.get['MC_UID'] = cookie.get("MC_UID")
